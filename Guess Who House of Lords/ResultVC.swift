...
class ResultVC: UIViewController {
    ...
    func showRating() {
        ...
        if s < 10 {
            rating = "Not Content"
            color = UIColor(red: 0, green: 0.5176, blue: 0.1608, alpha: 1)        }  else if s < 40 {
            rating = "Abstian"
            color = UIColor(red: 0.502, green: 0.7176, blue: 0, alpha: 1)
        } else if s < 60 {
            rating = "Content"
            color = UIColor(red: 0.7098, green: 0.4706, blue: 0, alpha: 1)
        } else if s < 80 {
            rating = "Comendation"
            color = UIColor(red: 0.6471, green: 0.2275, blue: 0, alpha: 1)
        } else if s <= 100 {
            rating = "Elevated to the Peerage"
            color = UIColor(red:0.50, green:0.00, blue:0.00, alpha:1.0)
        }
    ...
    func setupViews() {
        ...
        lblRating.widthAnchor.constraint(equalToConstant: 350).isActive=true
        lblRating.heightAnchor.constraint(equalToConstant: 100).isActive=true
        showRating()
